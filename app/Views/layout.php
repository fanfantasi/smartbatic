...
<html>
  <head>
	...
	<body class="fixed-navbar fixed-layout">
        ...
        <header class="header">
		    <div class="page-brand">
		        <a class="link" href="#">
                    <img src="<?= base_url(); ?>/logos.png" width="30" style="vertical-align: sub;" title="">
		            <span class="brand">
                        <?= $apps;?>
		            </span>
		            <span class="brand-mini">SBC</span>
		        </a>
		    </div>
		      ...
		      <ul class="nav navbar-toolbar">
		        <li class="dropdown dropdown-user">
		            <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
		            	<img src="<?= base_url('uploads/avatars/profil.png');?>">
		                <span></span><?= $profil['displayname'];?><i class="fa fa-angle-down m-l-5"></i></a>
        ...
        <nav class="page-sidebar" id="sidebar">
		  <div id="sidebar-collapse">
		    <div class="admin-block d-flex">
		        <div>
		        	<img src="<?= base_url('uploads/avatars/profil.png');?>" width="45px">
		        </div>
		        <div class="admin-info">
		            <div class="font-strong"><?= $profil['displayname'];?></div><small>
		              Administrator
		            </small>
		        </div>
		    </div>
        ...
        <div class="content-wrapper">
            ...
            <footer class="page-footer">
                <div class="font-13"><?= date('Y');?> © <b>Smart Batik Class </b>.</div>
   ...
   <!-- BEGIN PAGA BACKDROPS-->
    ...
    <div class="preloader-backdrop" style="margin-left:250px; margin-top: 56px;">
